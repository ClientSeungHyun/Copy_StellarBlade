...
ASBEnemy::ASBEnemy()
{
	...
	StateComponent = CreateDefaultSubobject<USBStateComponent>("State");

	// OnDeath Delegate에 함수 바인딩.
	AttributeComponent->OnDeath.AddUObject(this, &ThisClass::OnDeath);
}

void ASBEnemy::BeginPlay()
{
	Super::BeginPlay();

}

void ASBEnemy::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
}

float ASBEnemy::TakeDamage(float Damage, const FDamageEvent& DamageEvent, AController* EventInstigator, AActor* DamageCauser)
{
...
void ASBEnemy::ImpactEffect(const FVector& Location)
{
	if (ImpactSound)
	{
...
void ASBEnemy::HitReaction(const AActor* Attacker)
{
...
UAnimMontage* ASBEnemy::GetHitReactAnimation(const AActor* Attacker) const
{
